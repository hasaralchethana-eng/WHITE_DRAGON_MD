...
async function connectToWA() {
  ...
  console.log("Connecting WHITE_DRAGON");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("WHITE_DRAGON installed successful ✅");
      console.log("WHITE_DRAGON connected to whatsapp ✅");

      let up = `WHITE_DRAGON connected successful ✅`;
      let up1 = `Hello Dragon, I made bot successful`;
...
app.get("/", (req, res) => {
  res.send("hey, WHITE DRAGON started✅");
});
app.listen(port, () =>
